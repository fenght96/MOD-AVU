...
class TwoStreamTwoStageDetector(BaseDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStreamTwoStageDetector, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(TwoStreamTwoStageDetector, self).init_weights(pretrained)
        self.backbone_1.init_weights(pretrained=pretrained)
    ...
    def extract_feat(self, img):
        ...
        w_2 = F.relu(torch.mean(x_2[-1].view(bs,c,-1),-1)).view(bs,c)
        w_all = torch.cat((F.relu(self.fc_rgb(w_1)), F.relu(self.fc_trm(w_2))),dim=1)
        w_all = F.relu(self.fc(w_all))
