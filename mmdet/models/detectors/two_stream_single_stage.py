...
class TwoStreamSingleStageDetector(BaseDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStreamSingleStageDetector, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(TwoStreamSingleStageDetector, self).init_weights(pretrained)
    ...
    def extract_feat(self, img):
        ...
        x = tuple([0.5*(x_1[i] + x_2[i]) for i in range(min(len(x_1), len(x_2)))])
        if self.with_neck:
            x = self.neck(x)
        return x
